...
### Using `match_parent`
![Application with match parent layout sizes](/cs2340-android-tutorial/color-match-parent.png)


`match_parent` takes up the width and height of the parent layout 

### Using `wrap_content`
![Application with wrap content layout sizes](/cs2340-android-tutorial/color-wrap-content.png)
