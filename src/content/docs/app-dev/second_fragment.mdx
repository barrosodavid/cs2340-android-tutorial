...
One possible result after following these steps is this:

![Second fragment design](/cs2340-android-tutorial/second-fragment-design.png)
...
![Navigation graph](/cs2340-android-tutorial/nav-graph.png)
...
![Navigation action selected](/cs2340-android-tutorial/action-selected.png)
...
![Add argument dialog](/cs2340-android-tutorial/add-my-arg.png)
...
<Code code={`public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
...
`} lang="java" title="java/com.example.myfirstapp/FirstFragment" />
...
<Code code={`// Import navArgs to handle navigation arguments
...
`} lang="java" title="java/com.example.myfirstapp/SecondFragment" />
...
![App result](/cs2340-android-tutorial/app-result.png)